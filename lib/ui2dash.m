    ...
    switch ui_widget.Type
        case 'uislider'
            ...
            if isstruct(sld.UserData) % RangeSlider
                ...
                component = py.dash.dcc.RangeSlider(pyargs('id',id,...
                ...
                component = py.dash.dcc.Slider(pyargs('id',id, ...
        ...
        case 'uibuttongroup'
            ...
            if lnbut>0
                ...
                component = py.dash.dcc.RadioItems(pyargs('id', id, ...
                            'options', opts, ...
        ...
        case 'uidropdown'
            ...
            component = py.dash.dcc.Dropdown(pyargs('id', id, ...
            'options', opts, 'value', drpdown.Value ));
        
        % Button Properties
        case 'uibutton'
            btn = ui_widget;
            component = py.dash.html.Button(btn.Text, pyargs(...
                'id',id, 'n_clicks', 0 ));
        ...
        case 'uidatepicker'
            ...
            component = py.dash.dcc.DatePickerSingle(pyargs(...
        ...
        case 'uicheckbox'
            ...
            if chkbox.Value == false
                component = py.dash.dcc.Checklist(pyargs('id', id, ...
                    'options', opts, 'value', {})); 
            else
        ...
        case 'uitextarea'
            ...
            component = py.dash.dcc.Textarea(pyargs(...
                'id', id, ...
                'value', values, ...
        ...
        case 'uilabel'
            ...
            component = py.dash.html.Label(pyargs(...
        ...
        case 'uihyperlink'
            hlink = ui_widget;
            component = py.dash.dcc.Link(pyargs(...
                'id',id, 'href', hlink.URL, 'target', '_blank', 'children', hlink.Text));
        
        % Image Properties
        case 'uiimage'
            img = ui_widget;
            component = py.dash.html.Img(pyargs(...
        ...
        case 'uitable'
            ...
            if isstruct(ui_widget.UserData)
                ...
                component = py.dash.dash_table.DataTable(pyargs(items{:}));
            % for html.Table as container for other elements
                ...
                for i=1:sz(1)
                    cols=py.list();
                    for j=1:sz( 2)
                        cl = py.dash.html.Td(pyargs( ...
                            'id', table.UserData(i, j), 'children', table.Data(i, j)));
                        cols.append(cl);
                    end                
                    rows.append(py.dash.html.Tr(cols));                
                end
                component = py.dash.html.Table(pyargs( 'children', rows));
             end
        ...
        case 'uitabgroup'
            ...
            for i=1:tabln
                ...
                tabs.append(py.dash.dcc.Tab(pyargs( ...
                    'label', tb.Title,...
                    'value', tb.Tag,...
                    'children', nest)));
            end
            %tab group
            component = py.dash.dcc.Tabs(pyargs(...
                'id', id, 'children', tabs, 'value', tabs{1}.value,...
                    'style', py.dict(pyargs('padding', num2str(pad)+"px"))));            
            
        %numeric edit field
        case 'uinumericeditfield'
            component = py.dash.dcc.Input(...
